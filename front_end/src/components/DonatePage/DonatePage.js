...
function DonatePage() {
  return (
    <div className="DonatePage">
      <span className="AboutUs" style={{left: '373px', top: '47px'}}>
        About us
      </span>
      <span className="AboutUs" style={{left: '468px', top: '47px', width: '123px'}}>
        About Children
      </span>
      <span className="AboutUs" style={{left: '620px', top: '47px', width: '139px'}}>
        News・Volunteer
      </span>
      <div className="AboutUs" style={{left: '787px', top: '47px', width: '138px'}}>
        Philanthropists
      </div>
